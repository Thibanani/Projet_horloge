...
set_property PACKAGE_PIN R2 [get_ports sw_cumul]					
	set_property IOSTANDARD LVCMOS33 [get_ports sw_cumul]
...
set_property PACKAGE_PIN V7 [get_ports n_pointdecimal]							
	set_property IOSTANDARD LVCMOS33 [get_ports n_pointdecimal]
...
#Led seconde
set_property PACKAGE_PIN A17 [get_ports {n_bargraphcommun[5]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {n_bargraphcommun[5]}]
set_property PACKAGE_PIN C16 [get_ports {n_bargraphcommun[4]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {n_bargraphcommun[4]}]
set_property PACKAGE_PIN C15 [get_ports {n_bargraphcommun[3]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {n_bargraphcommun[3]}]
set_property PACKAGE_PIN R18 [get_ports {n_bargraphcommun[2]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {n_bargraphcommun[2]}]
set_property PACKAGE_PIN P17 [get_ports {n_bargraphcommun[1]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {n_bargraphcommun[1]}]
set_property PACKAGE_PIN M19 [get_ports {n_bargraphcommun[0]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {n_bargraphcommun[0]}]
    
set_property PACKAGE_PIN P18 [get_ports {secondes[9]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {secondes[9]}]
set_property PACKAGE_PIN N17 [get_ports {secondes[8]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {secondes[8]}]
set_property PACKAGE_PIN B16 [get_ports {secondes[7]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {secondes[7]}]
set_property PACKAGE_PIN L17 [get_ports {secondes[6]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {secondes[6]}]
set_property PACKAGE_PIN K17 [get_ports {secondes[5]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {secondes[5]}]
set_property PACKAGE_PIN A15 [get_ports {secondes[4]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {secondes[4]}]
set_property PACKAGE_PIN A14 [get_ports {secondes[3]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {secondes[3]}]
set_property PACKAGE_PIN A16 [get_ports {secondes[2]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {secondes[2]}]
set_property PACKAGE_PIN B15 [get_ports {secondes[1]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {secondes[1]}]
set_property PACKAGE_PIN M18 [get_ports {secondes[0]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {secondes[0]}]