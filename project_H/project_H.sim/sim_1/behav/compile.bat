...
xelab -m64 --debug typical --relax -L xil_defaultlib -L secureip --snapshot sim_2_behav --prj C:/Users/Pierre-Olivier/Documents/GitHub/Projet_horloge/project_H/project_H.sim/sim_1/behav/sim_2.prj   xil_defaultlib.sim_2
if errorlevel 1 (
